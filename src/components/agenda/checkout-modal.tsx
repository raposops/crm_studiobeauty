...
export default function CheckoutModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md bg-modal border border-slate-300 shadow-2xl shadow-slate-950/25 ring-1 ring-black/5 rounded-t-3xl sm:rounded-3xl max-h-[90dvh] flex flex-col animate-fade-in-up overflow-hidden">
        {/* Header */}
