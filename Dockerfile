...
ENV EVOLUTION_COBRANCA_INSTANCE_NAME=${EVOLUTION_COBRANCA_INSTANCE_NAME:-fidusnovo}
ENV EVOLUTION_COBRANCA_API_KEY=${EVOLUTION_COBRANCA_API_KEY:-E82B9CB836AA-4A8E-808C-3B25D7B3C1A8}
