...
# Build Arguments from Easypanel (apenas variáveis NEXT_PUBLIC_ necessárias no build estático)
...
ENV NEXT_PUBLIC_EVOLUTION_API_KEY=${NEXT_PUBLIC_EVOLUTION_API_KEY:-E82B9CB836AA-4A8E-808C-3B25D7B3C1A8}
ENV NEXT_PUBLIC_EVOLUTION_INSTANCE_NAME=${NEXT_PUBLIC_EVOLUTION_INSTANCE_NAME:-fidusnovo}
